...
namespace WarBox.UI
{
    public class TabBuilder
    {
        ...
        public void Build()
        {
            ...
            {
                WarBoxUtils.WarBoxError("Error: Could not find 'Button_Other' to clone for tab creation.");
                return;
            }
            ...
            if (otherTab == null)
            {
                WarBoxUtils.WarBoxError("Error: Could not find 'Tab_Other' to clone for tab creation.");
                return;
            }
